...
export const content: Record<Locale, SiteContent> = {
  sr: {
    ...
    hero: {
      title: "Vaš prostor - od ideje do ugradnje,\nna jednom mestu.",
      subtitle:
    ...
    about: {
      kicker: "O nama",
      heading: "Sve u jednom timu.\nDizajn, tehnička razrada, izrada nameštaja, ugradnja.",
      paragraphs: [
    ...
    portfolio: {
      ...
      projects: [
        ...
        },
        {
          ...
          images: [
            "https://zeliak7tezbysyo8.public.blob.vercel-storage.com/images/portfolio/nis-ostrvo-kuhinja-01.webp",
            "https://zeliak7tezbysyo8.public.blob.vercel-storage.com/images/portfolio/nis-ostrvo-kuhinja-02.webp",
            "https://zeliak7tezbysyo8.public.blob.vercel-storage.com/images/portfolio/nis-ostrvo-kuhinja-03.webp",
            "https://zeliak7tezbysyo8.public.blob.vercel-storage.com/images/portfolio/nis-ostrvo-kuhinja-04.webp",
          ],
        },
      ],
    },
  ...
  en: {
    ...
    hero: {
      title: "Your space - from idea to installation,\nin one place.",
      subtitle:
    ...
    about: {
      kicker: "About us",
      heading: "Everything under one team.\nDesign, technical planning, furniture production, installation.",
      paragraphs: [
